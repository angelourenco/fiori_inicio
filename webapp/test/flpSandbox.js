		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices",
									"targetURL": "#invoices2invoice2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"invoices2invoice2-display": {
								"semanticObject": "invoices2invoice2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=invoices2.invoice2",
									"url": sap.ui.require.toUrl("invoices2/invoice2")
								}
							}
						}
					}
